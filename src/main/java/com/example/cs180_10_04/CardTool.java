...
/**
 * A program that allows a user to input information on cards and its properties.
 *
    ...
    public static void main(String[] args)
    {
        ...
        if (addCard.equals("Yes") || addCard.equals("yes"))
        {
            ...
            while(cont)
            {
                ...
                switch(addRarity)
                {
                    ...
                    case 2:
                        ...
                        receipt += ("U:" + addName1 + ';');
                        System.out.println(anotherPrompt);
                        String cont2 = s.nextLine();
                        if (cont2.equals("Yes") || cont2.equals("yes"))
                        {
                            cont = true;
                        } else
                        {
                    ...
                    case 3:
                        ...
                        if (cont3.equals("Yes") || cont3.equals("yes"))
                        {
                            cont = true;
                        } else
                        {
                    ...
                    case 4:
                        ...
                        if (cont4.equals("Yes") || cont4.equals("yes"))
                        {
                            cont = true;
                        } else
                        {
                    ...
                    case 5:
                        ...
                        receipt += ("L:" + addName4 + ';');
                        System.out.println(anotherPrompt);
                        String cont5 = s.nextLine();
                        if (cont5.equals("Yes") || cont5.equals("yes"))
                        {
                            cont = true;
                        } else
                        {
            ...
            if (printR == true)
            {
                ...
                System.out.println(totalCostMessage + String.format("%.2f" , totalCost) + ".");
